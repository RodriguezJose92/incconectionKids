...
export default function EventsManagement() {
  ...
  const handleDeleteEvent = async () => {
    ...
    try {
      ...
      alert(
        "Hubo un error al eliminar el evento. Por favor intenta de nuevo."
      );
    }
  };
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <div className="flex space-x-2">
          <Dialog open={isMassUploadOpen} onOpenChange={setIsMassUploadOpen}>
            ...
            <DialogContent>
              <DialogHeader>
                <DialogTitle>Subir Eventos Masivamente</DialogTitle>
              </DialogHeader>
              <div className="space-y-4">
                ...
                <p className="text-sm text-muted-foreground">
                  El archivo debe contener: título, descripción, fecha_inicio,
                  fecha_fin, hora_inicio, hora_fin, ubicación, categoría
                </p>
                <Button
                  onClick={() => setIsMassUploadOpen(false)}
                  className="w-full"
                >
                  Subir Eventos
                </Button>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setEventForm({ ...eventForm, ubicacion: e.target.value })
                    }
